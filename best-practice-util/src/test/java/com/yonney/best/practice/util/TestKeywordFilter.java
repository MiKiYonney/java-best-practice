package com.yonney.best.practice.util;
...
public class TestKeywordFilter {
    ...
    public void setUp() throws IOException {
        text = read("ar12150.txt");
        keywords = getKeywords("sen1063.txt");
    }
    ...
    private String read(String fileName) throws IOException {
        InputStream is = TestKeywordFilter.class.getClassLoader().getResourceAsStream(fileName);
        BufferedReader reader = new BufferedReader(new InputStreamReader(is));
